            ...
            <TableHeader className="sticky top-0 z-10 bg-card">
              <TableRow className="bg-primary/5">
                ...
                <TableHead style={COL_ICON_STYLE} className="text-center px-0">
                  <List className="h-3.5 w-3.5 text-muted-foreground/40 mx-auto" />
                </TableHead>
                {/* Col 2 — Chevron slot */}

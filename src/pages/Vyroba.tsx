          ...
          <Sheet open={mobileVyrobaProjektOpen} onOpenChange={setMobileVyrobaProjektOpen}>
            ...
            >
              <div className="flex flex-col h-full">
                ...
                {todayDayIndex >= 0 && (
                  <div className="shrink-0 px-4 pt-3 pb-[72px] border-t border-border bg-background">
                    <button
            ...
            return (
              <Sheet open={mobileDaylogOpen} onOpenChange={setMobileDaylogOpen}>
                ...
                >
                  ...
                  <div className="shrink-0 px-4 pt-3 pb-[72px] border-t border-border bg-background space-y-2">

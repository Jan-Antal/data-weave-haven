...
export default function Vyroba({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn("relative shrink-0 flex items-center gap-2 px-3 text-xs overflow-x-auto overflow-y-visible scrollbar-hide whitespace-nowrap", isMobile ? "z-10" : "z-30")}

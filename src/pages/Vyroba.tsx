        ...
        <Sheet open={mobileDetailOpen} onOpenChange={setMobileDetailOpen}>
          <SheetContent side="bottom" className="h-[85vh] rounded-t-2xl p-0 overflow-hidden" style={{ paddingBottom: "calc(56px + env(safe-area-inset-bottom, 0px))" }}>
            <div ref={dragMobileDetail.ref} className="flex flex-col h-full">
              ...
              {todayDayIndex >= 0 && (
                <div className="shrink-0 px-4 py-3 border-t border-border bg-background" style={{ paddingBottom: "calc(12px + 56px + env(safe-area-inset-bottom, 0px))" }}>
                  <button
        ...
        if (isMobile) {
          return (
            <Sheet open={logModalOpen} onOpenChange={setLogModalOpen}>
              <SheetContent side="bottom" className="rounded-t-2xl p-0 max-h-[90dvh] flex flex-col" style={{ paddingBottom: "calc(56px + env(safe-area-inset-bottom, 0px))" }}>
